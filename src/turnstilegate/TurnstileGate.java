...
public class TurnstileGate implements INConnectorEvent  {
     ...
     */
      ...
      public TurnstileGate() {
        ...
        try {
            ...
            System.out.println("Listening to gate 2....");
            readTCPSetting();
        } catch (Exception e) {
    ...
    public CommandDetail getCommandDetail() { 
        ...
        tcpClient.Timeout = 10000;//连接超时时间（毫秒）
        tcpClient.RestartCount = 0;//重新连接次数		
        Door8800Identity idt = new Door8800Identity("MC-5924T2301001", "FFFFFFFF", E_ControllerType.Door8900);
